"""Bot core client"""
# Copyright (C) 2020 - 2021  gauravsingh0, <https://github.com/gauravsingh0.git>
#
...
class Elena(TelegramBot, DataBase, PluginExtender):
    """ElenaBot Client"""
    ...
    async def begin(self, loop: Optional[asyncio.AbstractEventLoop] = None) -> "Elena":
        """Start ElenaBot"""
        if loop:
